...
- **Technical SEO Auditor** - Технический SEO аудит *(планируется)*
...
| **Technical SEO Auditor** | 🔄 *Планируется* | Технический аудит сайтов, Core Web Vitals, crawling |
...
- [ ] Technical SEO Auditor (Operational)
