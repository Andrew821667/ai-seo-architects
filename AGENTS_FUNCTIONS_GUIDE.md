...
**Методологии:**
- СПИН: Situation → Problem → Implication → Need-payoff
- Валюта: ₽ (российский рынок)
- Objection Types: Price, Authority, Need, Trust, Timing
...
**Ценовые модели:**
- Fixed Price: фиксированная стоимость проекта
- Retainer: ежемесячный ретейнер
- Performance-based: оплата по результатам
- Hybrid: комбинированная модель
...
**Link Types:**
- Editorial Links: редакционные ссылки
- Guest Posts: гостевые публикации
- Resource Links: ссылки из ресурсных страниц
- Brand Mentions: упоминания бренда
- Partnership Links: партнерские ссылки
...
- Share of Voice: доля голоса в поиске
- Keyword Gap Analysis: анализ пробелов в ключевых словах
- Content Gap Analysis: анализ пробелов в контенте
- Technical SEO Benchmarking: бенчмаркинг технического SEO
...
- Conversion Reports: отчеты по конверсиям
- ROI Analysis: анализ окупаемости инвестиций
...
- **CRM:** Интеграция с HubSpot, Salesforce
